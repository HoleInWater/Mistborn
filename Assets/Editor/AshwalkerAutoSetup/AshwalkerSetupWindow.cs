// AshwalkerSetupWindow.cs
//
// Opens from Ashwalker > Auto Setup Player.
//
...
public class AshwalkerSetupWindow : EditorWindow
{
    ...
    [MenuItem("Ashwalker/Player/Auto Setup Player")]
    public static void Open()
    {
        var w = GetWindow<AshwalkerSetupWindow>("Auto Setup Player");
    ...
    void DrawHeader()
    {
        ...
        GUILayout.Label("Ashwalker — Auto Setup Player", h);
    ...
    void RunSetup()
    {
        ...
        Undo.RegisterFullObjectHierarchyUndo(_player, "Ashwalker Auto Setup Player");
