...
/// </summary>
public static class MistbornGlobalSettings
{
    [Header("Allomancy Constants - Physical")]
    ...
    [Header("Allomancy Constants - Spiritual")]
    ...
    public const float InquisitorPewterStrength = 3.5f;
    public const float KolossRageSpeedMult = 2f;
    public const float HazekillerCoordinationRadius = 5f;
