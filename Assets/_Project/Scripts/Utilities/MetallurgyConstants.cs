...
/// <summary>
/// Centralized storage for all Metallurgy-related constants and tuning values.
...
public static class MetallurgyConstants
{
    ...
    // Temporal Metals
    public const float OraculumTimeScale = 0.6f;
    public const float OraculumShadowLeadTime = 0.4f; // Seconds ahead of target
    ...
    // Spiritual Metals
    public const float RevelumRevealRange = 15f;
    public static readonly Vector3 RevelumShadowOffset = new Vector3(0.8f, 0f, -0.4f);
    public static readonly Color RevelumGhostColor = new Color(0.8f, 0.3f, 0.1f, 0.5f);
    ...
    // ── MAG Burn Durations (Ashwalker Adventure Game, canonical source) ─────────
    ...
    /// <summary>Oraculum burn duration: 30 real seconds at max reserve</summary>
    public const float OraculumBurnDuration       = 30f;
    ...
    /// <summary>Iron (Hauler) burn duration: 20 real minutes</summary>
    ...
    /// <summary>Steel (Launcher) burn duration: 20 real minutes</summary>
    ...
    public const float OraculumDrainRate    = DefaultMaxReserve / OraculumBurnDuration;      // ≈ 3.333/s
