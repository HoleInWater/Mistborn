...
public class MetallurgyTreeUI : MonoBehaviour
{
    public VisualTreeAsset nodeTemplate; // Drag your SkillNode UXML here
    public MetallurgySkill[] allMetallurgySkills;   // Drag your Skill assets here

    void OnEnable()
    {
        // Get the root of your UI Document
        var root = GetComponent<UIDocument>().rootVisualElement;
        var container = root.Q<VisualElement>("MetallurgyTabContent"); // Name must match UI Builder

        foreach (var skill in allMetallurgySkills)
        {
