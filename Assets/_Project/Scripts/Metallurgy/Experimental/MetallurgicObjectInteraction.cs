...
/// </summary>
public class MetallurgicObjectInteraction : MonoBehaviour
{
    ...
    void OnCollisionEnter(Collision collision)
    {
        ...
        float kineticEnergy = MetallurgyPhysicsFormulas.CalculateKineticEnergy(mass, impactSpeed);
    ...
    /// <summary>
    /// Apply an Metallurgic force to this object (called by SteelPush/IronPull).
    /// </summary>
    public void ApplyMetallurgicForce(Vector3 force, bool isPush)
    {
        if (rb == null) return;
...
/// <summary>
/// Handles player-object collision when running into Metallurgic objects.
/// </summary>
public class PlayerObjectCollision : MonoBehaviour
{
    ...
    void OnCollisionEnter(Collision collision)
    {
        MetallurgicObjectInteraction obj = collision.gameObject.GetComponent<MetallurgicObjectInteraction>();
        if (obj == null) return;
