/* MetallurgicAbilityData.cs
 *
 * ScriptableObject defining an individual Metallurgic ability with all
...
[CreateAssetMenu(fileName = "NewAbility", menuName = "Ashwalker/Metallurgic Ability")]
public class MetallurgicAbilityData : ScriptableObject
{
    [Header("Identity")]
    public string abilityName;
    public string description;
    public MetallurgySkill.MetalType requiredMetal;
    public Sprite icon;
