...
/// <summary>
/// Implements the Gold Metallurgy ability (Augur).
/// Lore: Shows a "Gold Shadow" (potential past/alternate self) of the player.
/// </summary>
[PlayerComponent("Metallurgy Metals", order: 110)]
public class Gold : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        isBurning = metallurgist != null && metallurgist.IsBurning() && metallurgist.GetCurrentMetal() == MetallurgySkill.MetalType.Gold;
