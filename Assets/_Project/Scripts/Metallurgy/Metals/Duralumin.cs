...
/// <summary>
/// Duralumin Metallurgy — supercharges the NEXT metal burned.
...
/// </summary>
[PlayerComponent("Metallurgy Metals", order: 140)]
public class Duralumin : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        isBurning = metallurgist != null && metallurgist.IsBurning()
                 && metallurgist.GetCurrentMetal() == MetallurgySkill.MetalType.Duralumin;
    ...
    void PrimeBurst()
    {
        ...
        metallurgist.isDuraluminPrimed = true;
        ...
        metallurgist.DrainMetal(MetallurgySkill.MetalType.Duralumin,
            metallurgist.GetMetalReserve(MetallurgySkill.MetalType.Duralumin));
    ...
    {
        hasPrimed = false;
        if (metallurgist != null) metallurgist.isDuraluminPrimed = false;
    }
    ...
    /// </summary>
    public void ApplyBurstEffect(MetallurgySkill.MetalType metal, GameObject player)
    {
        switch (metal)
        {
        ...
        if (metallurgist != null)
            metallurgist.DrainMetal(metal, metallurgist.GetMetalReserve(metal));
