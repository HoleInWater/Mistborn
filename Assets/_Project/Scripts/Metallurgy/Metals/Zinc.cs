...
/// <summary>
/// Implements the Zinc Metallurgy ability (Riot emotions).
/// Standardized to follow the Metallurgist-centric burn system.
/// </summary>
[PlayerComponent("Metallurgy Metals", order: 50)]
public class Zinc : MonoBehaviour
{
    ...
    void Update()
    {
        isBurning = metallurgist != null && metallurgist.IsBurning() && metallurgist.GetCurrentMetal() == MetallurgySkill.MetalType.Zinc;
