...
/// <summary>
/// Implements the Cadmium Metallurgy ability (Pulser).
...
/// </summary>
[PlayerComponent("Metallurgy Metals", order: 180)]
public class Cadmium : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        isBurning = metallurgist != null && metallurgist.IsBurning() && metallurgist.GetCurrentMetal() == MetallurgySkill.MetalType.Cadmium;
