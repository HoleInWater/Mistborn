...
/// <summary>
/// Implements the Electrum Metallurgy ability (Oracle).
/// Lore: Shows multiple "Future Shadows" of the player to prevent Oraculum-strikes.
/// </summary>
[PlayerComponent("Metallurgy Metals", order: 120)]
public class Electrum : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        isBurning = metallurgist != null && metallurgist.IsBurning() && metallurgist.GetCurrentMetal() == MetallurgySkill.MetalType.Electrum;
