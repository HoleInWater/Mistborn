...
/// <summary>
/// Implements the Bendalloy Metallurgy ability (Slider).
...
/// </summary>
[PlayerComponent("Metallurgy Metals", order: 170)]
public class Bendalloy : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        isBurning = metallurgist != null && metallurgist.IsBurning() && metallurgist.GetCurrentMetal() == MetallurgySkill.MetalType.Bendalloy;
