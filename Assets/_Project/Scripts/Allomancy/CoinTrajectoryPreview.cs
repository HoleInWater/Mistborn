...
public class CoinTrajectoryPreview : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        bool shouldShow = showOnAim && Input.GetMouseButton(1)
                       ...
                       && allomancer != null
                       && allomancer.GetMetalReserve(AllomancySkill.MetalType.Steel) > 0;
    ...
    void UpdateTrajectory()
    {
        ...
        float force = AllomancyPhysicsFormulas.CalculateAllomanticForce(
            A * flare, playerRb.mass, AllomancyPhysicsFormulas.COIN_MASS, 1f);
        float coinVel = AllomancyPhysicsFormulas.CalculateCoinVelocity(
            force, 2f, AllomancyPhysicsFormulas.COIN_MASS);
        ...
        for (int i = 0; i < previewPoints; i++)
        {
            ...
            points[i] = AllomancyPhysicsFormulas.PredictPosition(launchPos, velocity, t);
