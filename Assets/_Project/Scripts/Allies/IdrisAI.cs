...
/// <summary>
/// Idris companion AI — Valdris Keeper and Storecrafter.
/// Lore: Idris uses Storecraft (pewter for strength, steel for speed, gold for healing).
...
/// </summary>
public class IdrisAI : MonoBehaviour
{
    [Header("Support")]
    ...
    Transform FindNearestThreat()
    {
        ...
        foreach (var e in AshwalkerRegistry.ActiveEnemies)
        {
            if (e == null) continue;
    ...
    public void OnSupportRequested(Transform enemy) { /* Idris avoids combat */ }
}
