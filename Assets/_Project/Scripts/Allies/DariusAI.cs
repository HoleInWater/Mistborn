...
/// <summary>
/// Darius companion AI — the Survivor of Ember Pits. Full Ashwalker.
/// Fights alongside the player using Steel Pushes, Pewter-enhanced melee,
/// and Oraculum dodges. Charismatic combat bark system.
/// </summary>
public class DariusAI : MonoBehaviour
{
    [Header("Combat")]
    ...
    void CombatBark(string type)
    {
        ...
        string[] steelBarks = {
            ...
            "The Ashen King won't save you from coins!"
        };
        string[] meleeBarks = {
            "Pewter makes this easy!", "You're slower than a Bloodbrute!",
