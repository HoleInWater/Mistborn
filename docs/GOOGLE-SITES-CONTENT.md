...
## QUICK EMBED (Full Site in One Embed)

If Google Sites supports HTML embed, paste this into an embed block. It loads the full site from wherever you host the HTML files:

```html
<iframe src="YOUR_HOSTED_URL_HERE" width="100%" height="800" frameborder="0" style="border:none;"></iframe>
```

Replace `YOUR_HOSTED_URL_HERE` with wherever you host the `website/index.html` file (Netlify, Vercel, any web host).

---

## PAGE-BY-PAGE CONTENT (for manual Google Sites pages)
...
**Subheader:** THE FINAL EMPIRE

**Tagline:** Master the metals. Defy the god. Change the world.

**Buttons:** Discover More | Watch Trailer
...
- Iron — Pull metals toward you. Reel yourself to anchors, disarm enemies.
- Pewter — Enhance your body. Superhuman strength, speed, and endurance.
- Tin — Enhance your senses. See in the dark, hear whispers, detect danger.
...
- Electrum — See your own future shadows.
...
(Add screenshots, concept art, and trailer video embed here)

Sections: Screenshots | Videos | Concept Art
...
**Ezra** — Co-Leader
Shares leadership responsibilities and helps guide the overall direction of the project alongside Garrett.

SECTION LEADS

**Deegan** — Section Leader
Leads a development section and coordinates team members within their department.

**Lori** — Section Leader
Manages a development section and oversees workflow and task delegation for their team.
...
**Landon Adams**
Creative Director, Crimson Blade Interactive
