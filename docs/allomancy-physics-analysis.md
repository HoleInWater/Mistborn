# Metallurgy Science: Steel Push Physics Analysis

*Based on Reddit r/Ashwalker physics discussions*
...
When a Launcher pushes a metal object:
- Force on coin = Force on Launcher (equal and opposite)
- This means if you push a coin with 1700N, you experience 1700N recoil

### 2. Self-Launch Capability
If a Ashwalker can launch themselves upward at ~1g (gravity acceleration):
...
2. Launcher railgun effect (coins would be hypersonic)
3. No counter-force pushing (Darius vs Camon scene)

**Book Evidence:**
- Ember can hover over a coin without oscillating (not constant force)
- Push force varies based on target velocity
- Less force applied to metallurgist than target (unless heavy/fixed object)
...
- Books show force DECREASES with distance (Ember hovering scene)
...
### Key Book Evidence:
From The Ashen Dominion (Ember hovering):
...
> "Iron/steel metallurgy cannot be explained as just a straight out force... Newton's 3rd law is ignored / works differently... It's magic, ok?"
...
**Key takeaway:** Metallurgy follows "hard magic" rules - consistent enough to be predictable, but physics is modified for storytelling and gameplay.
...
**From Coppermind:**
> "The force of the Push upon an object is inversely proportional to the Launcher's distance to said object. This continues until the Launcher hits a zenith, or point of maximum altitude."
...
**From Coppermind:**
> "This continues until the Launcher hits a zenith, or point of maximum altitude. This zenith is higher for more powerful Steelpushes, such as those burned in conjunction with duralumin, or with more massive steel anchors."
...
**From Coppermind:**
> "Steel Metallurgy is strongly resisted by the body of sophonts, thus making metalminds embedded into the body difficult to push. Due to this, some Storecrafters choose to surgically implant their metalminds into their body."
...
### Rule 6: Conservation of Momentum with Storecraft

**From Coppermind:**
> "The Law of Conservation of Momentum holds when using iron Storecraft. Therefore, a Launcher who has access to iron Storecraft can alter their mass in order to increase or decrease their velocity. When one increases their mass, their velocity would decrease in order to equalize their momentum, and vice versa."

**For Our Game:**
- Basic physics: momentum is conserved
- If player is lighter (via Storecraft), they accelerate faster but can't push as hard
- If player is heavier, they push harder but accelerate slower

### Rule 7: Steelpush is NOT Pure Newtonian

**Key Insight:** While we use Newtonian physics as a base, Metallurgy modifies it:
...
1. **Lines emerge from chest**: "When burning steel, blue lines emerge from the Launcher and connect themselves to pieces of nearby metal."
...
5. **Perception-based**: "What an Metallurgist 'Sees' is based on what they think about the world." Skilled Metallurgists can see lines to individual metal parts.

6. **Center of mass**: "The line usually points to the objects center of mass."

7. **Color**: Blue due to Connection lines in the greater universe (the original author's color choice).
...
- Lines are visible only when burning steel/iron (Metallurgic Sight ability)
- Skilled Metallurgists could see more detail (future feature)
...
- **Coppermind Wiki - Steel page**: https://coppermind.net/wiki/Steel
  - Weight proportionality rule (Section: Metallurgic Use)
  - Distance inverse relationship (Section: Metallurgic Use)  
  - Zenith point mechanics (Section: Metallurgic Use)
  - Spiritual Realm blue lines (Section: Metallurgic Use)
  - Body resistance to Steelpush (Section: Metallurgic Use)
  - Conservation of momentum with Storecraft (Section: Synergy with Iron Storecraft)

### Community Sources (Secondary)
- Reddit r/Ashwalker physics discussions
- 17th Shard forums (detailed simulations)
- The Ashen Dominion (TFE Ch. 8 - Ember's steel sight)
- The Wellspring (Wax's steel bubble mechanics)

### Book References
- The Ashen Dominion, Chapter 7: "Steelpushing is the art of burning steel to push metals away"
